      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-8 py-16 lg:py-24 w-full">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href={WHATSAPP_URL} target="_blank" rel="noreferrer"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-7 py-3.5 rounded-full font-semibold hover:bg-primary/90 transition shadow-lg shadow-primary/25">
