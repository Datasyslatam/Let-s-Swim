    ...
    <>
      <header className="fixed top-0 inset-x-0 z-50 bg-white/55 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-5 lg:px-8 flex items-center justify-between h-24">
          ...
          <nav className="hidden lg:flex items-center gap-7 text-sm font-medium text-foreground/80 ml-auto mr-4">
            {links.map(l => (
...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl hover:bg-[#20ba5a] hover:scale-110 active:scale-95 transition-all duration-300 group"
    >
      <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-40 animate-ping pointer-events-none group-hover:animate-none"></span>
      <svg
        viewBox="0 0 24 24"
        width="30"
        height="30"
